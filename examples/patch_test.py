"""Compile the patch-test MVP example via the programmatic API."""
...
def build_example_context() -> dict:
    """Construct the patch-test frontend context."""
    return build_context(
        ...
        boundaries=[
            {"name": "anchor", "face": "x0", "type": "dirichlet", "dofs": [0, 1, 2], "value": 0.0},
            {"name": "stretch", "face": "x1", "type": "dirichlet", "dofs": [0], "value": "u_bar"},
        ],
    )
