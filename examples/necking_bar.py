"""Compile the necking-bar MVP example via the programmatic API."""
...
def build_example_context() -> dict:
    """Construct the necking-bar frontend context."""
    return build_context(
        dim=3,
        cell_type="hex8",
        formulation="total_lagrangian",
        material_type="j2_power_law",
        params={"E": 200e3, "nu": 0.3, "sigma_y0": 450.0, "K": 1200.0, "n": 0.2},
        boundaries=[
            {"name": "x_sym", "face": "x0", "type": "dirichlet", "dofs": [0], "value": 0.0},
            {"name": "y_sym", "face": "y0", "type": "dirichlet", "dofs": [1], "value": 0.0},
            {"name": "z_fix", "face": "z0", "type": "dirichlet", "dofs": [2], "value": 0.0},
            {"name": "pull", "face": "z1", "type": "dirichlet", "dofs": [2], "value": "u_bar"},
        ],
    )
