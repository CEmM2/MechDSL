"""Compile the plastic uniaxial MVP example via the programmatic API."""
...
def build_example_context() -> dict:
    """Construct the plastic uniaxial frontend context."""
    return build_context(
        dim=3,
        cell_type="hex8",
        formulation="total_lagrangian",
        material_type="j2_power_law",
        params={"E": 200e3, "nu": 0.3, "sigma_y0": 250.0, "K": 1000.0, "n": 1.0},
        boundaries=[
            {"name": "fix", "face": "x0", "type": "dirichlet", "dofs": [0, 1, 2], "value": 0.0},
            {"name": "pull", "face": "x1", "type": "dirichlet", "dofs": [0], "value": "u_bar"},
        ],
    )
...
def main() -> None:
    ...
    print("example: plastic_uniaxial")
