...
This task folder corresponds to [`dev/plans/ph10_preq.md`](../../plans/ph10_preq.md), the Plan-B Phase 10 prerequisite plan, which has been **superseded** by [`dev/plans/recovery_plan_latex_contract.md`](../../plans/recovery_plan_latex_contract.md) (Phase 7 / R6 archival, P7-5).
