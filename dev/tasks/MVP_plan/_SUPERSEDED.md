...
This task folder corresponds to [`dev/plans/MVP_plan.md`](../../plans/MVP_plan.md), which has been **superseded** by [`dev/plans/recovery_plan_latex_contract.md`](../../plans/recovery_plan_latex_contract.md) (Phase 7 / R6 archival, P7-5).
